...
report_power -verbose -hierarchy > saif/saif_hht1_685_bus.rpt
...
update_power
#set_power_analysis_options -waveform_format fsdb -waveform_output vcd
report_power -verbose -hierarchy > saif/saif_hht1_jpwh.rpt
...
update_power
#set_power_analysis_options -waveform_format fsdb -waveform_output vcd
report_power -verbose -hierarchy > saif/saif_hht1_rbsa.rpt
